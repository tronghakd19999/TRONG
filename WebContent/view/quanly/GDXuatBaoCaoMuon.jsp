...
listkh = (new BaoCaoThueDAO()).getAllKhachHangDongThueDuMuon();
%>
...
<title> Xuất báo cáo thuế cá nhân nộp muộn</title>
</head>
<%
if (listkh != null ) {
%>
<body>
	<h3>Xuất báo cáo theo tháng đóng tiền thuế muộn tháng 2</h3>
							...
							<table class="table">
								<thead>
									<tr>
										...
										<th>Nghề</th>
										<th>Mức lương</th>
										<th>Tiền đóng thuế hiện thời</th>
